          ...
          {artists.map((artist) => {
            ...
            return (
              <div key={artist.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 relative">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-center"><strong>Followers:</strong> {artist.followers.toLocaleString()}</p>
                <p className="text-gray-700 dark:text-gray-300 text-center"><strong>Popularity:</strong> {artist.popularity}</p>
                <p className="text-gray-700 dark:text-gray-300 text-center"><strong>Genres:</strong> {parsedGenres.length > 0 ? parsedGenres.join(', ') : 'N/A'}</p>
                {spotifyUrl && (
                  <a
                    href={spotifyUrl}
                    target="_blank"
